...
export const PREMIUM_COAT_ART = {
  slate: "/art/dogs/premium/slate-matched.webp",
...
export const OUTFITS = {
  ...
  peppermint: { key: "peppermint", name: "Peppermint Holly", slot: "full", layer: "clothing", season: "winter", rarity: "rare", emoji: "🍬", description: "A festive peppermint-and-holly holiday set.", cost: 75, fullArt: "/art/wardrobe/premium/peppermint_holly-restored.webp", collectionArt: "/art/wardrobe/collections/peppermint_holly.png" },
  ...
  icy_snowflake: { key: "icy_snowflake", name: "Icy Snowflake", slot: "full", layer: "clothing", season: "winter", rarity: "rare", emoji: "❄️", description: "A crystalline winter ensemble threaded with frosted blue blossoms and snowflake sparkle.", cost: 95, fullArt: "/art/wardrobe/premium/icy_snowflake-restored.webp", collectionArt: "/art/wardrobe/collections/icy_snowflake.png" },
  ...
  peppermint_holly: { key: "peppermint_holly", name: "Peppermint Holly", slot: "full", layer: "clothing", season: "winter", rarity: "rare", emoji: "🍬", description: "A complete peppermint holiday look with candy bows, holly, lace, and snowy trim.", cost: 95, fullArt: "/art/wardrobe/premium/peppermint_holly-restored.webp", collectionArt: "/art/wardrobe/collections/peppermint_holly.png" },
};
