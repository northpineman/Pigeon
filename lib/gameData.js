export const SPECIES = {
  rock: { name: "Blue Iggy", bodyScale: 1, tail: "plain", colors: ["slate", "pied", "white"], incomeMult: 1 },
  king: { name: "Fawn Iggy", bodyScale: 1.15, tail: "belly-patch", colors: ["cinnamon", "white", "tan"], incomeMult: 1.3 },
  fantail: { name: "Red Iggy", bodyScale: 0.98, tail: "tufted", colors: ["cinnamon", "black", "white"], incomeMult: 1.15 },
  ringneck: { name: "Pied Iggy", bodyScale: 0.95, tail: "neck-ring", colors: ["white", "slate", "pied"], incomeMult: 0.9 },
  diamond: { name: "Cream Iggy", bodyScale: 0.82, tail: "spotted", colors: ["tan", "white", "cinnamon"], incomeMult: 0.8 },
  nun: { name: "Black & Tan Iggy", bodyScale: 1, tail: "face-mask", colors: ["black", "tan", "white"], incomeMult: 1.1 },
};
...
export const TABS = [
  { key: "loft", label: "Kennel", icon: "🐕", color: "#FF7A59" },
...
export const DEFAULT_CONFIG = {
  ...
  decorations: [
    ...
    { key: "perches", name: "Squeaky Toy Basket", cost: 90, bonus: 7, emoji: "🧸" },
