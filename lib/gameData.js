export const SPECIES = {
  rock: { name: "Rock Pigeon", bodyScale: 1, tail: "fan-small", colors: ["slate", "pied", "white"], incomeMult: 1 },
  king: { name: "King Pigeon", bodyScale: 1.28, tail: "short", colors: ["white", "pied", "cinnamon"], incomeMult: 1.3 },
  fantail: { name: "Fantail Pigeon", bodyScale: 0.95, tail: "fan-large", colors: ["white", "black", "pied"], incomeMult: 1.15 },
  ringneck: { name: "Ring-necked Dove", bodyScale: 0.86, tail: "long", colors: ["tan", "white", "iridescent"], incomeMult: 0.9 },
  diamond: { name: "Diamond Dove", bodyScale: 0.56, tail: "long-thin", colors: ["slate", "white", "cinnamon"], incomeMult: 0.8 },
  nun: { name: "Nun Pigeon", bodyScale: 0.92, tail: "fan-small", colors: ["white", "black", "pied"], incomeMult: 1.1 },
};
...
export const TABS = [
  { key: "loft", label: "Loft", icon: "🏠", color: "#FF7A59" },
  { key: "nests", label: "Nests", icon: "🪺", color: "#FF6FA5" },
  { key: "events", label: "Events", icon: "🎉", color: "#8C6FE0" },
...
export function computeUnlockedKeys(save) {
  ...
  if (flags.bloombreakerWon) keys.push("bloombreaker_win");
