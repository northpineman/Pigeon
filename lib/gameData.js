export const SPECIES = {
  rock: { name: "Italian Greyhound · Slate", bodyScale: 1, tail: "plain", colors: ["slate", "pied", "white"], incomeMult: 1 },
  king: { name: "Italian Greyhound · Fawn", bodyScale: 1.15, tail: "belly-patch", colors: ["cinnamon", "white", "tan"], incomeMult: 1.3 },
  fantail: { name: "Italian Greyhound · Cinnamon", bodyScale: 0.98, tail: "tufted", colors: ["cinnamon", "black", "white"], incomeMult: 1.15 },
  ringneck: { name: "Italian Greyhound · Pied", bodyScale: 0.95, tail: "neck-ring", colors: ["white", "slate", "pied"], incomeMult: 0.9 },
  diamond: { name: "Italian Greyhound · Cream", bodyScale: 0.82, tail: "spotted", colors: ["tan", "white", "cinnamon"], incomeMult: 0.8 },
  nun: { name: "Italian Greyhound · Black & Tan", bodyScale: 1, tail: "face-mask", colors: ["black", "tan", "white"], incomeMult: 1.1 },
};
...
export const TABS = [
  { key: "home", label: "Meadow", icon: "🌿", color: "#6E9B7A" },
  { key: "kennel", label: "My Iggies", icon: "🐕", color: "#FF7A59" },
  { key: "nests", label: "Breeding", icon: "🍼", color: "#FF6FA5" },
  { key: "events", label: "Events", icon: "🗺️", color: "#8C6FE0" },
  { key: "explore", label: "Explore", icon: "⚔️", color: "#B96A34" },
  { key: "games", label: "Games", icon: "🎮", color: "#6EC6FF" },
  { key: "shop", label: "Shops", icon: "⭐", color: "#4CAF7D" },
  { key: "collection", label: "Collection", icon: "📚", color: "#8C6FE0" },
];

export const BOTS = [
  { key: "twig", name: "Twig the Squirrel", emoji: "🐿️", power: 8, seedReward: 12, itemChance: 0.15 },
  { key: "crow", name: "Mocking Crow", emoji: "🐦‍⬛", power: 14, seedReward: 18, itemChance: 0.2 },
  { key: "raccoon", name: "Bandit Raccoon", emoji: "🦝", power: 20, seedReward: 24, itemChance: 0.25 },
  { key: "boar", name: "Grumpy Boar", emoji: "🐗", power: 28, seedReward: 32, itemChance: 0.3 },
  { key: "owl", name: "Elder Owl", emoji: "🦉", power: 36, seedReward: 40, itemChance: 0.35 },
  { key: "fox", name: "Sly Fox Duelist", emoji: "🦊", power: 45, seedReward: 50, itemChance: 0.4 },
  { key: "wolf", name: "Timber Wolf", emoji: "🐺", power: 55, seedReward: 65, itemChance: 0.45 },
  { key: "dragon", name: "Meadow Wyrm", emoji: "🐉", power: 70, seedReward: 90, itemChance: 0.55 },
];


export const DAILY_QUESTS = [
  { key: "visit", name: "Meadow Stroll", description: "Visit the Meadow today.", goal: 1, reward: 15, icon: "🌿" },
  { key: "care", name: "Good Guardian", description: "Feed or bathe an Iggy.", goal: 1, reward: 20, icon: "🫧" },
  { key: "play", name: "Playtime", description: "Finish a Meadow game.", goal: 1, reward: 25, icon: "🎮" },
  { key: "explore", name: "Wander Beyond", description: "Take an Iggy exploring.", goal: 1, reward: 25, icon: "🗺️" },
  { key: "collect", name: "Gatherer", description: "Collect kennel income.", goal: 1, reward: 15, icon: "🌾" },
];

export const MEADOW_NEWS = [
  { icon: "🌸", title: "Spring is blooming", text: "Seasonal outfits, discoveries, and Meadow activities rotate throughout the year." },
  { icon: "🧬", title: "Every Iggy has a story", text: "Breeding creates generations, inherited traits, appearances, and permanent family records." },
  { icon: "🏆", title: "Build your collection", text: "Discover coats, eyes, outfits, achievements, and rare Iggies as your Meadow grows." },
];
...
export const DEFAULT_CONFIG = {
  ...
  decorations: [
    { key: "mats", name: "Cozy Dog Bed", cost: 40, bonus: 4, emoji: "🛏️" },
    { key: "bath", name: "Bubble Bath Tub", cost: 70, bonus: 6, emoji: "🫧" },
    { key: "toy-basket", name: "Squeaky Toy Basket", cost: 90, bonus: 7, emoji: "🧸" },
    { key: "vine", name: "Agility Tunnel", cost: 120, bonus: 8, emoji: "🌀" },
    { key: "chimes", name: "Little Bell Collar", cost: 150, bonus: 10, emoji: "🔔" },
    { key: "rainbow", name: "Rainbow Sweater", cost: 55, bonus: 5, emoji: "🌈" },
  ],
  christmasItems: [
  ...
  seasonalIggies: [
    { key: "sb-holly", name: "Holly Iggy", speciesKey: "diamond", colorKey: "holly", cost: 70, season: "christmas" },
    { key: "sb-robin", name: "Robin Redbreast Iggy", speciesKey: "rock", colorKey: "robin", cost: 80, season: "christmas" },
    { key: "sb-peppermint", name: "Peppermint Iggy", speciesKey: "fantail", colorKey: "santa", cost: 110, season: "christmas" },
    { key: "sb-raven", name: "Raven Iggy", speciesKey: "ringneck", colorKey: "raven", cost: 80, season: "halloween" },
    { key: "sb-jack", name: "Jack-o'-Iggy", speciesKey: "king", colorKey: "pumpkin", cost: 100, season: "halloween" },
    { key: "sb-candycorn", name: "Candy Corn Iggy", speciesKey: "diamond", colorKey: "candycorn", cost: 65, season: "halloween" },
    { key: "sb-ghost", name: "Ghost Iggy", speciesKey: "fantail", colorKey: "ghost", cost: 90, season: "halloween" },
  ],
  seedPacks: [
  ...
  trainingItems: [
    { key: "potion", name: "Strength Potion", cost: 60, emoji: "💪", stat: "strength", amount: 2 },
    { key: "book", name: "Wisdom Book", cost: 60, emoji: "📖", stat: "wisdom", amount: 2 },
  ],
};
...
export function computeHappiness(bird, now, config, decorBonus) {
  ...
  const playBonus = bird.lastPlayedAt && bird.playHappiness ? Math.max(0, bird.playHappiness - ((now - bird.lastPlayedAt) / (24 * HOUR)) * bird.playHappiness) : 0;
  return clamp(Math.round(h * 0.55 + c * 0.25 + decorBonus + babyBonus + playBonus), 0, 100);
}
...
export function makeBird({ speciesKey, colorKey, stage, now, growAt, hatchAt }) {
  return {
    ...
    strength: 5,
    wisdom: 5,
    genetics: { generation: 0, traits: [], mutation: null },
    lineage: { motherId: null, fatherId: null, bredAt: null },
    appearance: { eyeColor: "hazel", eyeStyle: "classic" },
  };
}
// Defensive readers — older saves won't have these fields yet.
export const getLife = (b) => (typeof b.life === "number" ? b.life : 100);
export const getMaxLife = (b) => (typeof b.maxLife === "number" ? b.maxLife : 100);
export const getStrength = (b) => (typeof b.strength === "number" ? b.strength : 5);
export const getWisdom = (b) => (typeof b.wisdom === "number" ? b.wisdom : 5);
...
export function computeUnlockedKeys(save) {
  ...
  if (birds.length >= 1) keys.push("first_iggy");
  if (birds.length >= 5) keys.push("five_iggies");
  if (birds.length >= 10) keys.push("ten_iggies");
  if (birds.some((b) => b.colorKey === "iridescent")) keys.push("rare_iggy");
  ...
  if (flags.seasonalAdopted) keys.push("seasonal_iggy");
