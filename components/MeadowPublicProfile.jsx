...
export default function MeadowPublicProfile({ profile, achievements = [], error }) {
  ...
  return <div className="site site-public-profile">
    <header className="meadow-profile-masthead"><Link href="/" className="meadow-profile-brand"><span className="meadow-brand-paw"><MeadowIcon name="paw" /></span><span><small>SMALL DOGS. BIG ADVENTURES.</small><strong>Iggy Meadow</strong></span></Link><Link href="/" className="btn btn-ghost">← Return to the Meadow</Link></header>
